*pbp_b16_b19b_dental_vbid_uf.sas;
...
infile '.\pbp\pbp_b16_b19b_dental_vbid_uf.txt' delimiter = '09'x
...
proc sort data = pbp_b16_vbid out=out.pbp_b16_vbid;
  by Pbp_a_hnumber pbp_a_plan_identifier segment_id;
run;

proc print data = out.pbp_b16_vbid(obs = 10);
  title 'pbp_b16_b19b_dental_vbid_uf file ';
run;

proc means data = out.pbp_b16_vbid;
  title 'pbp_b16_b19b_dental_vbid_uf file ';
run;

proc freq data = out.pbp_b16_vbid;
table
	pbp_a_ben_cov
	pbp_a_plan_type
	orgtype
...
proc contents data = out.pbp_b16_vbid;
  title 'pbp_b16_vbid data';
run;