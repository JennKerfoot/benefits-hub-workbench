...
length
	...
	orgtype                          $2
	bid_id                           $13
	pbp_d_opt_use_mand_16b_yn        $1
	pbp_d_opt_use_mand_16b1_yn       $1
	pbp_d_opt_use_mand_16b2_yn       $1
	pbp_d_opt_use_mand_16b3_yn       $1
	pbp_d_opt_use_mand_16b4_yn       $1
	pbp_d_opt_use_mand_16b5_yn       $1
	pbp_d_opt_use_mand_16b6_yn       $1
	pbp_d_opt_use_mand_16c_yn        $1
	pbp_d_opt_use_mand_16c1_yn       $1
	pbp_d_opt_use_mand_16c2_yn       $1
	pbp_d_opt_use_mand_16c3_yn       $1
	pbp_d_opt_use_mand_16c4_yn       $1
	pbp_d_opt_use_mand_16c5_yn       $1
	pbp_d_opt_use_mand_16c6_yn       $1
	pbp_d_opt_use_mand_16c7_yn       $1
	pbp_d_opt_use_mand_16c8_yn       $1
	pbp_d_opt_use_mand_16c9_yn       $1
	pbp_d_opt_use_mand_16c10_yn      $1
...
infile '.\pbp\pbp_step16.txt' delimiter = '09'x
...
input
	...
	bid_id
	version
	pbp_d_opt_use_mand_16b_yn
	pbp_d_opt_use_mand_16b1_yn
	pbp_d_opt_use_mand_16b2_yn
	pbp_d_opt_use_mand_16b3_yn
	pbp_d_opt_use_mand_16b4_yn
	pbp_d_opt_use_mand_16b5_yn
	pbp_d_opt_use_mand_16b6_yn
	pbp_d_opt_use_mand_16c_yn
	pbp_d_opt_use_mand_16c1_yn
	pbp_d_opt_use_mand_16c2_yn
	pbp_d_opt_use_mand_16c3_yn
	pbp_d_opt_use_mand_16c4_yn
	pbp_d_opt_use_mand_16c5_yn
	pbp_d_opt_use_mand_16c6_yn
	pbp_d_opt_use_mand_16c7_yn
	pbp_d_opt_use_mand_16c8_yn
	pbp_d_opt_use_mand_16c9_yn
	pbp_d_opt_use_mand_16c10_yn
...
label
	...
	pbp_d_opt_use_mand_16b_yn        = 'OppSupp Cost Same INN 16B YN'
	pbp_d_opt_use_mand_16b1_yn       = 'OppSupp Cost Same INN 16B1 YN'
	pbp_d_opt_use_mand_16b2_yn       = 'OppSupp Cost Same INN 16B2 YN'
	pbp_d_opt_use_mand_16b3_yn       = 'OppSupp Cost Same INN 16B3 YN'
	pbp_d_opt_use_mand_16b4_yn       = 'OppSupp Cost Same INN 16B4 YN'
	pbp_d_opt_use_mand_16b5_yn       = 'OppSupp Cost Same INN 16B5 YN'
	pbp_d_opt_use_mand_16b6_yn       = 'OppSupp Cost Same INN 16B6 YN'
	pbp_d_opt_use_mand_16c_yn        = 'OppSupp Cost Same INN 16C YN'
	pbp_d_opt_use_mand_16c1_yn       = 'OppSupp Cost Same INN 16C1 YN'
	pbp_d_opt_use_mand_16c2_yn       = 'OppSupp Cost Same INN 16C2 YN'
	pbp_d_opt_use_mand_16c3_yn       = 'OppSupp Cost Same INN 16C3 YN'
	pbp_d_opt_use_mand_16c4_yn       = 'OppSupp Cost Same INN 16C4 YN'
	pbp_d_opt_use_mand_16c5_yn       = 'OppSupp Cost Same INN 16C5 YN'
	pbp_d_opt_use_mand_16c6_yn       = 'OppSupp Cost Same INN 16C6 YN'
	pbp_d_opt_use_mand_16c7_yn       = 'OppSupp Cost Same INN 16C7 YN'
	pbp_d_opt_use_mand_16c8_yn       = 'OppSupp Cost Same INN 16C8 YN'
	pbp_d_opt_use_mand_16c9_yn       = 'OppSupp Cost Same INN 16C9 YN'
	pbp_d_opt_use_mand_16c10_yn      = 'OppSupp Cost Same INN 16C10 YN'
...
proc sort data = pbp_step16 out=out.pbp_step16;
  by Pbp_a_hnumber pbp_a_plan_identifier segment_id;
run;

proc print data = out.pbp_step16(obs = 10);
  title 'pbp_step16 file ';
run;

proc means data = out.pbp_step16;
  title 'pbp_step16 file ';
run;

proc freq data = out.pbp_step16;
table
	pbp_a_ben_cov
	pbp_a_plan_type
	orgtype
...
proc contents data = out.pbp_step16;
  title 'pbp_step16 data';
run;