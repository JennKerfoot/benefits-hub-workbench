...
length
	...
	orgtype                          $2
	bid_id                           $13
	pbp_d_opt_use_mand_13_yn         $1
	pbp_d_opt_use_mand_13a_yn        $1
	pbp_d_opt_use_mand_13b_yn        $1
	pbp_d_opt_use_mand_13c_yn        $1
	pbp_d_opt_use_mand_13d_yn        $1
	pbp_d_opt_use_mand_13e_yn        $1
	pbp_d_opt_use_mand_13f_yn        $1
	pbp_d_opt_use_mand_13g_yn        $1
...
infile '.\pbp\pbp_step13.txt' delimiter = '09'x
...
input
	...
	bid_id
	version
	pbp_d_opt_use_mand_13_yn
	pbp_d_opt_use_mand_13a_yn
	pbp_d_opt_use_mand_13b_yn
	pbp_d_opt_use_mand_13c_yn
	pbp_d_opt_use_mand_13d_yn
	pbp_d_opt_use_mand_13e_yn
	pbp_d_opt_use_mand_13f_yn
	pbp_d_opt_use_mand_13g_yn
	pbp_b13a_bendesc_yn
	...
	pbp_b13g_maxplan_per_d
	pbp_b13g_maxenr_yn
	pbp_b13g_maxenr_amt
	pbp_b13g_maxenr_per
	pbp_b13g_maxenr_per_d
	pbp_b13g_coins_yn
	pbp_b13g_coins_min_pct
	pbp_b13g_coins_max_pct
	pbp_b13g_ded_yn
	pbp_b13g_ded_amt
	pbp_b13g_copay_yn
	pbp_b13g_copay_min_amt
...
label
	...
	pbp_d_opt_use_mand_13_yn         = 'OppSupp Cost Same INN 13 YN'
	pbp_d_opt_use_mand_13a_yn        = 'OppSupp Cost Same INN 13A YN'
	pbp_d_opt_use_mand_13b_yn        = 'OppSupp Cost Same INN 13B YN'
	pbp_d_opt_use_mand_13c_yn        = 'OppSupp Cost Same INN 13C YN'
	pbp_d_opt_use_mand_13d_yn        = 'OppSupp Cost Same INN 13D YN'
	pbp_d_opt_use_mand_13e_yn        = 'OppSupp Cost Same INN 13E YN'
	pbp_d_opt_use_mand_13f_yn        = 'OppSupp Cost Same INN 13F YN'
	pbp_d_opt_use_mand_13g_yn        = 'OppSupp Cost Same INN 13G YN'
	...
	pbp_b13g_attestation             = 'Other 4 SNP Attestation'
	pbp_b13g_bendesc_service         = 'Other 4 SNP Name of Service'
	pbp_b13g_bendesc_amo             = 'Other 4 SNP Ben AMO'
	pbp_b13g_maxplan_yn              = 'Other 4 SNP Max Plan YN'
	pbp_b13g_maxplan_amt             = 'Other 4 SNP Max Plan Amt'
	pbp_b13g_maxplan_per             = 'Other 4 SNP Max Plan Per'
	pbp_b13g_maxplan_per_d           = 'Other 4 SNP Max Plan Per Desc'
	pbp_b13g_maxenr_yn               = 'Other 4 SNP Max Enr YN'
	pbp_b13g_maxenr_amt              = 'Other 4 SNP Max Enr Amt'
	pbp_b13g_maxenr_per              = 'Other 4 SNP Max Enr Per'
	pbp_b13g_maxenr_per_d            = 'Other 4 SNP Max Enr Per Desc'
	pbp_b13g_coins_yn                = 'Other 4 SNP Coinsurance YN'
	pbp_b13g_coins_min_pct           = 'Other 4 SNP Min Coins Pct'
	pbp_b13g_coins_max_pct           = 'Other 4 SNP Max Coins Pct'
	pbp_b13g_ded_yn                  = 'Other 4 SNP Deductible YN'
	pbp_b13g_ded_amt                 = 'Other 4 SNP Deductible Amt'
	pbp_b13g_copay_yn                = 'Other 4 SNP Copayment YN'
	pbp_b13g_copay_min_amt           = 'Other 4 SNP Min Copy Amt'
	pbp_b13g_copay_max_amt           = 'Other 4 SNP Max Copy Amt'
	pbp_b13g_auth_yn                 = 'Other 4 SNP Auth YN'
	pbp_b13g_refer_yn                = 'Other 4 SNP Referral YN'
	pbp_d_opt_identifier             = 'Opt Sup Benefits Identifier'
;

run;

proc sort data = pbp_step13 out=out.pbp_step13;
  by Pbp_a_hnumber pbp_a_plan_identifier segment_id;
run;

proc print data = out.pbp_step13(obs = 10);
  title 'pbp_step13 file ';
run;

proc means data = out.pbp_step13;
  title 'pbp_step13 file ';
run;

proc freq data = out.pbp_step13;
table
	pbp_a_ben_cov
	pbp_a_plan_type
	orgtype
...
proc contents data = out.pbp_step13;
  title 'pbp_step13 data';
run;