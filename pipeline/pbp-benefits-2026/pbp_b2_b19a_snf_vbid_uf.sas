*pbp_b2_b19a_snf_vbid_uf.sas;

libname out '.\sas_data_sets\PBP';
options pageno=1 linesize = 200 nocenter;

data pbp_b2_b19a_vbid;
...
infile '.\pbp\pbp_b2_b19a_snf_vbid_uf.txt' delimiter = '09'x
...
proc sort data = pbp_b2_b19a_vbid out=out.pbp_b2_b19a_vbid;
  by Pbp_a_hnumber pbp_a_plan_identifier segment_id;
run;

proc print data = out.pbp_b2_b19a_vbid(obs = 10);
  title 'pbp_b2_b19a_snf_vbid_uf file ';
run;

proc means data = out.pbp_b2_b19a_vbid;
  title 'pbp_b2_b19a_snf_vbid_uf file ';
run;

proc freq data = out.pbp_b2_b19a_vbid;
table
	pbp_a_ben_cov
	pbp_a_plan_type
	orgtype
...
proc contents data = out.pbp_b2_b19a_vbid;
  title 'pbp_b2_b19a_vbid data';
run;