...
length
	...
	orgtype                          $2
	bid_id                           $13
	pbp_d_opt_use_mand_10b_yn        $1
	pbp_d_opt_use_mand_10b1_yn       $1
	pbp_d_opt_use_mand_10b2_yn       $1
...
infile '.\pbp\pbp_step10b.txt' delimiter = '09'x
...
input
	...
	bid_id
	version
	pbp_d_opt_use_mand_10b_yn
	pbp_d_opt_use_mand_10b1_yn
	pbp_d_opt_use_mand_10b2_yn
	pbp_b10b_bendesc_yn
...
label
	...
	pbp_d_opt_use_mand_10b_yn        = 'OppSupp Cost Same INN 10B YN'
	pbp_d_opt_use_mand_10b1_yn       = 'OppSupp Cost Same INN 10B1 YN'
	pbp_d_opt_use_mand_10b2_yn       = 'OppSupp Cost Same INN 10B2 YN'
...
proc sort data = pbp_step10b out=out.pbp_step10b;
  by Pbp_a_hnumber pbp_a_plan_identifier segment_id;
run;

proc print data = out.pbp_step10b(obs = 10);
  title 'pbp_step10b file ';
run;

proc means data = out.pbp_step10b;
  title 'pbp_step10b file ';
run;

proc freq data = out.pbp_step10b;
table
	pbp_a_ben_cov
	pbp_a_plan_type
	orgtype
...
proc contents data = out.pbp_step10b;
  title 'pbp_step10b data';
run;